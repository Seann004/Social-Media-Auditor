...
const ROLE_OPTIONS: { value: UserRole; label: string; description: string }[] = [
  ...
  { value: 'admin', label: 'Administrator', description: 'Manage compliance guidelines and generate synthetic check items' },
]
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-9 pt-8 pb-6 border-b border-border-light">
            ...
            <h1 className="text-2xl font-bold text-heading tracking-tight">Create account</h1>
            <p className="text-secondary text-base mt-1.5">Register to access SafetyAudit.</p>
          </div>
